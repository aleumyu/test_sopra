...
## AUTHENTICATION & AUTHORIZATION
  ...
  - Weak point: once a user get the authentication and if he/she fillters by username, especially by that of admin, he/she can get the user data, then can see admin's user id, which can be used to authenticate later as admin
